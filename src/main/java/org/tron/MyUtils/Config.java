...
public class Config {
    ...
    public static String WALLET_DB_FILE_BAK = System.getProperty("user.home") + "/tronwallet/" + "TronWalletBackup.dat";
    public static String WALLET_DB_FILE = System.getProperty("user.home") + "/tronwallet/" + "TronWallet.dat";
