...
import static org.tron.MyUtils.WTUtils.unchecked;

public class GuiUtils {
    public static final int UI_ANIMATION_TIME_MSEC = 200;
    ...
    public synchronized static void blurOut(Node node) {
    ...
    public synchronized static void blurIn(Node node) {
    ...
    public synchronized static ScaleTransition zoomIn(Node node) {
        return zoomIn(node, 0);
    }

    public synchronized static ScaleTransition zoomIn(Node node, int delayMillis) {
